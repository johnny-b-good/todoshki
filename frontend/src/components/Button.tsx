...
export const Button: FC<ButtonProps> = ({
  ...
  return (
    <HeadlessButton
      className={clsx(
        "flex items-center gap-2 whitespace-nowrap rounded border px-2 py-1 text-sm shadow-sm outline-none transition-colors",
        ...
        variant === "text" &&
          "border-transparent bg-transparent text-slate-700 shadow-none hover:bg-white hover:bg-opacity-50 hover:text-teal-500",
        className,
      )}
      {...props}
    >
